        ...
        return (
          <div className="space-y-4">
            <div>
              ...
              <textarea 
                className="w-full rounded-lg border border-slate-700 bg-slate-900/50 p-3 text-sm text-white placeholder-slate-500 focus:border-sky-500 focus:ring-2 focus:ring-sky-500/30 focus:outline-none" 
                rows={4}
            ...
            <div>
              ...
              <select 
                className="w-full rounded-lg border border-slate-700 bg-slate-900/50 p-2.5 text-sm text-white focus:border-sky-500 focus:ring-2 focus:ring-sky-500/30 focus:outline-none" 
                value={form.gender} 
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  className="w-full rounded-lg border border-slate-700 bg-slate-900/50 py-2.5 pl-9 pr-3 text-sm text-white placeholder-slate-500 focus:border-sky-500 focus:ring-2 focus:ring-sky-500/30 focus:outline-none" 
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="flex items-start gap-4">
                {form.profilePhoto ? (
                  <div className="group relative h-24 w-24 overflow-hidden rounded-lg border-2 border-sky-500/30">
                  ...
                  <div className="flex h-24 w-24 items-center justify-center rounded-lg border-2 border-dashed border-slate-700 bg-slate-800/50">
                    <Camera className="h-8 w-8 text-slate-600" />
                  </div>
                )}
                <div className="flex-1">
                  <input 
                    className="w-full rounded-lg border border-slate-700 bg-slate-900/50 p-2.5 text-sm text-white placeholder-slate-500 focus:border-sky-500 focus:ring-2 focus:ring-sky-500/30 focus:outline-none" 
            ...
            <div>
              <label className="mb-2 block text-sm font-medium text-slate-300">Gallery Photos</label>
          ...
          <div className="space-y-4">
              ...
              {splitCsv(form.skills).length > 0 && (
                <div className="mt-2 flex flex-wrap gap-1">
                  {splitCsv(form.skills).map((skill, idx) => (
                    <span key={idx} className="rounded-full bg-sky-950/50 px-2 py-1 text-xs text-sky-400">
                      {skill}
                    </span>
                  ))}
                </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  className="w-full rounded-lg border border-slate-700 bg-slate-900/50 py-2.5 pl-9 pr-3 text-sm text-white placeholder-slate-500 focus:border-sky-500 focus:ring-2 focus:ring-sky-500/30 focus:outline-none" 
                  placeholder="e.g., Massage, Cleaning, Moving (comma separated)"
              ...
              {splitCsv(form.categories).length > 0 && (
                <div className="mt-2 flex flex-wrap gap-1">
                  {splitCsv(form.categories).map((category, idx) => (
                    <span key={idx} className="rounded-full bg-purple-950/50 px-2 py-1 text-xs text-purple-400">
                      {category}
                    </span>
                  ))}
                </div>
      ...
      <div className="mx-auto max-w-4xl px-4">
        ...
        <div className="mb-8 text-center">
          <div className="mb-4 flex justify-center">
            <div className="rounded-full bg-gradient-to-r from-sky-500/20 to-blue-500/20 p-3">
              <User className="h-8 w-8 text-sky-400" />
            </div>
          </div>
          <h1 className="text-3xl font-bold text-white">Edit Profile</h1>
          <p className="mt-2 text-slate-400">Update your professional information and preferences</p>
        </div>
            ...
            <form onSubmit={save}>
              ...
              <div className="mt-8 flex items-center justify-between border-t border-slate-800 pt-6">
                ...
                <button
                  type="submit"
                  disabled={saving}
                  className="flex items-center gap-2 rounded-lg bg-gradient-to-r from-sky-600 to-sky-500 px-6 py-2 text-sm font-medium text-white transition hover:from-sky-500 hover:to-sky-400 disabled:opacity-50"
                >
                  {saving ? (
                    <>
            ...
            <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-xl border border-slate-700 bg-slate-900 p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  {form.profilePhoto ? (
                    <img src={form.profilePhoto} alt="Profile" className="h-20 w-20 rounded-full object-cover ring-4 ring-sky-500/30" />
                  ) : (
