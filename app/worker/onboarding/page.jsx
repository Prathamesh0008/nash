...
export default function WorkerOnboardingPage() {
  ...
  useEffect(() => {
    ...
    if (!text || !type || type === "info") return;
    const key = `${type}:${text}`;
    if (lastPopupRef.current === key) return;
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  />
                  <label
                    htmlFor="selfie-camera-upload"
                    className="flex cursor-pointer items-center gap-2 rounded-lg border border-fuchsia-500/60 bg-fuchsia-950/30 px-3 py-2 text-sm text-fuchsia-200 transition hover:bg-fuchsia-900/40"
                  >
